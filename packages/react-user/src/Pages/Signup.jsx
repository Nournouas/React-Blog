    ...
    <div className="h-screen flex flex-col items-center justify-center bg-secondary">
      ...
      <form onSubmit={handleFormSubmit} action="http://localhost:3001/signup" method='POST' className='flex flex-col gap-5'>
        <div className='flex flex-col justify-items-center items-start gap-3 w-100'>
          ...
          <input required type="email" id='email' name='email' className='border border-black-200 px-2 py-3 w-full' />
        </div>
        <div className='flex flex-col justify-items-center items-start gap-3 w-100'>
          <label htmlFor="name">Name:</label>
          <input required maxLength={24} minLength={2} type="text" id='name' name='name' className='border border-black-200 px-2 py-3 w-full' />
        </div>
        <div className='flex flex-col justify-items-center items-start gap-3 w-100'>
          <label htmlFor="password">Password:</label>
          <input type="password" maxLength={24} minLength={8} id='password' name='password' className='border border-black-200 px-2 py-3 w-full' />
        </div>
        <div className='flex flex-col justify-items-center items-start gap-3 w-100'>
          <label htmlFor="confirm-password">Confirm Password:</label>
          <input type="password" maxLength={24} minLength={8} id='confirm-password' name='confirm-password' className='border border-black-200 px-2 py-3 w-full' />
        </div>
