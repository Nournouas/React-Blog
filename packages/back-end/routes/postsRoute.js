...
const { getAllUnpublishedPosts, switchPostPublished, deleteComment, getAllPosts, createPost, getSinglePost, getOwnPosts, deletePost, createComment } = require("../controllers/postsController");
